...
const Chatbot = () => {
  ...
  const User = useSelector((state) => state.currentUserReducer) || "you"; // Provide default value as empty object
    ...
    <>
      <section>
        <div className="container" style={{ marginTop: '60px' }}>
          {/* <h3 className="text-center">Chatbot App</h3> */}
                  ...
                  <div className="question" style={{ textAlign: 'right' }}>
                    <p>
                      ...
                      <Avatar backgroundColor="green" >
                        ...
                        {User.email ? User.email.charAt(0).toUpperCase() : 'You:'}
                      </Avatar>
                      </div>
